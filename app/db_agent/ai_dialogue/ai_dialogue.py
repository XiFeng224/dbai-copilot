...
class AIDialogue:
    ...
    def _build_enhanced_prompt(self, question: str, question_type: str, context: str) -> str:
        ...
        prompts = {
            "performance": """
            你是一位经验丰富的数据库性能优化专家。请分析性能问题并提供详细的解决方案。
            请提供：
            1. 性能瓶颈分析
            2. 具体的优化建议（按优先级排序）
            3. 预期性能提升
            ...
            """,
            "general": """
            你是一位友好的数据库助手。请提供清晰、实用的回答。
            请使用通俗易懂的语言，结构清晰，重点突出。
            """
        }
        ...
        请使用专业但易于理解的语言，结构清晰，重点突出。提供具体、可操作的建议。
        """
